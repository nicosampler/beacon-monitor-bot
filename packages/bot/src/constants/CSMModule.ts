export const CSMModule = [
  ...
  { inputs: [], name: 'NoQueuedKeysToMigrate', type: 'error' },
  { inputs: [], name: 'NodeOperatorDoesNotExist', type: 'error' },
  { inputs: [], name: 'NotAllowedToRecover', type: 'error' },
  { inputs: [], name: 'NotEligibleForPriorityQueue', type: 'error' },
  ...
  { inputs: [], name: 'PriorityQueueAlreadyUsed', type: 'error' },
  { inputs: [], name: 'PriorityQueueMaxDepositsUsed', type: 'error' },
  ...
  },
  {
    inputs: [],
    name: 'EXIT_PENALTIES',
    outputs: [{ internalType: 'contract ICSExitPenalties', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: 'contract ICSParametersRegistry', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'nodeOperatorId', type: 'uint256' },
      { internalType: 'bytes', name: 'publicKey', type: 'bytes' },
      { internalType: 'uint256', name: 'withdrawalRequestPaidFee', type: 'uint256' },
