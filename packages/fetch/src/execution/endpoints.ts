...
export async function getBlock(
  ...
  const endpoints = [
    ...
    {
      url: `${env.EXECUTION_API_BKP_URL}/v2/api?chainid=${env.NODE_SENTINEL_CHAIN == 'mainnet' ? '1' : '100'}&module=block&action=getblockreward&blockno=${blockNumber}&apikey=${env.EXECUTION_API_BKP_KEY}`,
