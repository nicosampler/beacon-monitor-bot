const GENESIS_TIMESTAMP = Number(process.env.BEACON_GENESIS_TIMESTAMP);
const SLOT_DURATION_MS =
  Number(process.env.BEACON_SLOT_DURATION_IN_SECONDS) * 1000;
const SLOTS_PER_EPOCH = Number(process.env.BEACON_SLOTS_PER_EPOCH);
/**
