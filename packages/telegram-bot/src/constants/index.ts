...
export const FEE_REWARDS_IN_STABLE =
  process.env.FEE_REWARDS_IN_STABLE == "true";
...
export const ALERT_REPEAT_INTERVAL_MINUTES = Number(
  process.env.ALERT_REPEAT_INTERVAL_MINUTES
);
...
export const BEACON_API_REQUEST_PER_SECOND = Number(
  process.env.BEACON_API_REQUEST_PER_SECOND
);
export const BEACON_API_REQUEST_PER_MINUTE = Number(
  process.env.BEACON_API_REQUEST_PER_MINUTE
);
...
export const EXPLORER_API_REQUEST_PER_SECOND = Number(
  process.env.EXPLORER_API_REQUEST_PER_SECOND
);
export const EXPLORER_API_REQUEST_PER_DAY = Number(
  process.env.EXPLORER_API_REQUEST_PER_DAY
);

export const COINGECKO_TOKEN_PRICE_API_URL = process.env
  .COINGECKO_TOKEN_PRICE_API_URL as string;
...
export const CLAIM_COOL_DOWN_DAYS =
  process.env.CLAIM_COOLDOWN_DAYS == undefined
    ? 7
...
export const TG_ADMIN_USER_IDS = (
  (process.env.TG_ADMIN_USER_IDS as string) || ""
)
  .split(",")
  .map(Number);
